...
const IEEE_9_BUS = {
    ...
    bus: [
        ...
        [4, 1, 0, 0, 0, 0, 1, 1, 0, 230, 1, 1.1, 0.9],        // PQ - Transmission
        [5, 1, 125, 50, 0, 0, 1, 1, 0, 230, 1, 1.1, 0.9],     // PQ - Load A
        [6, 1, 90, 30, 0, 0, 1, 1, 0, 230, 1, 1.1, 0.9],      // PQ - Load B
        [7, 1, 0, 0, 0, 0, 1, 1, 0, 230, 1, 1.1, 0.9],        // PQ - Transmission
        [8, 1, 100, 35, 0, 0, 1, 1, 0, 230, 1, 1.1, 0.9],     // PQ - Load C
        [9, 1, 0, 0, 0, 0, 1, 1, 0, 230, 1, 1.1, 0.9]         // PQ - Transmission
    ],
    // Generator data: [GEN_BUS, PG, QG, QMAX, QMIN, VG, MBASE, STATUS, PMAX, PMIN]
    gen: [
    ...
    // Branch data: [F_BUS, T_BUS, R, X, B, RATE_A, RATE_B, RATE_C, TAP, SHIFT, STATUS]
    branch: [
        [1, 4, 0.0001, 0.0576, 0, 250, 250, 250, 0, 0, 1],    // Transformer G1-Bus4
        [4, 5, 0.017, 0.092, 0.158, 250, 250, 250, 0, 0, 1],
        [5, 6, 0.039, 0.17, 0.358, 150, 150, 150, 0, 0, 1],
        [3, 6, 0.0001, 0.0586, 0, 300, 300, 300, 0, 0, 1],    // Transformer G3-Bus6
        [6, 7, 0.0119, 0.1008, 0.209, 150, 150, 150, 0, 0, 1],
        [7, 8, 0.0085, 0.072, 0.149, 250, 250, 250, 0, 0, 1],
        [8, 2, 0.0001, 0.0625, 0, 250, 250, 250, 0, 0, 1],    // Transformer G2-Bus8
...
const IEEE_14_BUS = {
    ...
    branch: [
        ...
        [4, 7, 0.0001, 0.20912, 0, 0, 0, 0, 0.978, 0, 1],     // Transformer
        [4, 9, 0.0001, 0.55618, 0, 0, 0, 0, 0.969, 0, 1],     // Transformer
        [5, 6, 0.0001, 0.25202, 0, 0, 0, 0, 0.932, 0, 1],     // Transformer
...
const IEEE_30_BUS = {
    ...
    branch: [
        ...
        [6, 9, 0.0001, 0.208, 0, 65, 65, 65, 0.978, 0, 1],    // Transformer
        [6, 10, 0.0001, 0.556, 0, 32, 32, 32, 0.969, 0, 1],   // Transformer
        [9, 11, 0.0001, 0.208, 0, 65, 65, 65, 0, 0, 1],
        [9, 10, 0.0001, 0.11, 0, 65, 65, 65, 0, 0, 1],
        [4, 12, 0.0001, 0.256, 0, 65, 65, 65, 0.932, 0, 1],   // Transformer
        ...
        [28, 27, 0.0001, 0.396, 0, 65, 65, 65, 0.968, 0, 1],  // Transformer
